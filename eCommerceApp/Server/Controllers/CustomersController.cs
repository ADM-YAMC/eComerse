...
namespace eCommerceApp.Server.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<CustomersResponse> PostCustomers(Customers customers)
        {
            try
            {
                ...
                return new CustomersResponse() { ok=true, msj= "El cliente fue guardado..."};
            }
            catch (Exception)
            {

                return new CustomersResponse() { msj = "Ocurrio un errors..." };
            }
        }
